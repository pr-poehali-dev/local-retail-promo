  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-white/80 backdrop-blur-md border-b border-border">
      <div className="container mx-auto px-4 py-4 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <Button className="hidden md:flex gradient-primary text-white hover:opacity-90 transition-opacity">
          ...
          <Sheet open={isOpen} onOpenChange={setIsOpen}>
            ...
            <SheetContent side="right" className="w-[300px]">
              ...
              <nav className="flex flex-col gap-4 mt-8">
                ...
                <Button className="mt-4 gradient-primary text-white hover:opacity-90 w-full">
                  <Icon name="Store" className="mr-2 h-4 w-4" />
                  Подключить магазин
                </Button>
              </nav>
